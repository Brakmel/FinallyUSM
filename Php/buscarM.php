...
<header>
        ...
        <div class="baul_header">
            <p>En caso de que no escriba nada y le de a buscar apareceran todos los resultados, relacionados a "Mes"</p>
        </div>
    </header>
    ...
    <form class="form_buscador" action="" method="get">
        <input class="buscador" type="text" name="busqueda" placeholder="31-08-2022">
